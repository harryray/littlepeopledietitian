...
$resource_category = get_the_terms($post->ID, 'resource-category');
$document_type = get_the_terms($post->ID, 'document-type');
	...
	<div>
		...
		<div class="resource-archive__item--meta">
			<div class="col-md-8 col-12">
				...
				<p class="resource-archive__item--supertitle"><?php echo $resource_category[0]->name; ?></p>
			</div>
